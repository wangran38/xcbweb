<template>
  <div class="app-container">
    <div class="filter-container" style="margin:0 0 10px 0;">
      <el-input v-model="listQuery.shortname" placeholder="城市简称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
<script>
import { getlist} from '@/api/share/city'
