<template>
    <div class="app-container">
        <div class="filter-container" style="margin:0 0 2% 0;">
            ...
            <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-clear"
                @click="clearQuery">
                清空查询条件
            </el-button>
        </div>
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            ...
            <el-table-column label="用户id" align="center">
                <template slot-scope="{row}">
                    <span @click="setQuery(1, row.user_id)">{{ row.user_id }}</span>
                </template>
            </el-table-column>
...
<script>
import { scoreList } from '@/api/pointsManagement'
