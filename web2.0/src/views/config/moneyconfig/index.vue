<template>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="总平台百分比" width="110px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.level1 }}%</span>
          </template>
        </el-table-column>
        <el-table-column label="省级百分比" width="110px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.level2 }}%</span>
          </template>
        </el-table-column>
       <el-table-column label="市县百分比"  align="center">
          <template slot-scope="{row}">
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
          ...
          <el-form-item label="总平台百分比" prop="level1">
           <el-input-number v-model="temp.level1" />
          </el-form-item>
           <el-form-item label="省级百分比" prop="level2">
            <el-input-number v-model="temp.level2" />
          </el-form-item> 
           <el-form-item label="市县百分比" prop="level3">
            <el-input-number v-model="temp.level3" />
          </el-form-item> 
