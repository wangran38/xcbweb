<template>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="中奖ID" prop="id" sortable="custom" align="center" width="80" :class-name="getSortClass('id')">
          <template slot-scope="{row}">
  ...
  <span>{{ row.marketname }}</span>
      ...
      <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="getsignlistgroup" />
...
.article-textarea ::v-deep {
  ...
  <script>
  import { getlottery2list } from '@/api/lottery/lottery2'
 ...
 import Tinymce from '@/components/Tinymce'
  ...
  export default {
    ...
    methods: {
      ...
      getlottery2list() {
        this.listLoading = true
        getlottery2list(this.listQuery).then(response => {
            this.getlotteryrecordlist()
        //   this.list = response.data.listdata
        //   this.total = response.data.totalnum
