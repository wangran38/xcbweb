<template>
  ...
  <span>{{ row.marketname }}</span>
        ...
        <el-table-column label="经纬度" width="" align="center">
          <template slot-scope="{row}">
      ...
      <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="getmarketlist" />
...
.article-textarea ::v-deep {
  ...
  <script>
  import { getmarketlist } from '@/api/market/list/list'
